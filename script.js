const menu = [
  ...
  {id:"pizza-sandwiches",no:"04",title:"Pizza + Sandwiches",groups:[
    {name:"Pizza",items:[
      ["Italian Pizza",790],["Margherita Pizza",750],["Farmhouse Pizza",810],["Mexican Pizza",790],["Cottage Cheese Pesto Pizza",1050],["Tandoori Pizza",790],["Cottage Cheese Peri Peri Pizza",970],["Roasted Mushroom Pizza",820]
    ]},
    {name:"Sandwiches",items:[
      ["Spinach Cottage Cheese Sandwich",630],["Cottage Cheese Sandwich",620],["Avocado Sandwich",640],["Avocado Butter Croissant",690]
    ]},
    {name:"Salads",items:[
      ["Caesar Salad",370],["Exotic Vegetable Saute Salad",450],["Creamy Pasta Salad",490]
    ]}
  ]},
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  const recommendedItems=new Set([
    ...
    "Farmhouse Pizza","Cottage Cheese Pesto Pizza",
    "Spinach Cottage Cheese Sandwich","Avocado Butter Croissant",
    "Caesar Salad","Exotic Vegetable Saute Salad",
  ...
  menu.forEach((section,sectionIndex)=>{
    ...
    const groups=section.groups.map((group,groupIndex)=>{
      ...
      return `<details class="menu-group" open>
